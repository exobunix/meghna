...
export const SITE_CONFIG = {
  ...
  // Memory Polaroids & Lightbox with real photos of Meghna
  MEMORIES: [
    {
      id: "mem-1",
      src: "/images/meghna/Image-30109.jpg",
      caption: "That radiant laugh in the rain ❤️",
      date: "Pure Happiness",
      alt: "Meghna smiling radiantly in the rain",
      category: "smiles",
      rotation: -3,
    },
    {
      ...
      caption: "Grace, beauty, and timeless charm ✨",
      date: "Golden Elegance",
      alt: "Meghna in beautiful traditional saree",
      category: "favorites",
      rotation: 2,
    },
    {
      ...
      caption: "Eyes that speak a thousand unspoken words ❤️",
      date: "Deeply Cherished",
      alt: "Meghna deep wine portrait",
      category: "moments",
      rotation: -2,
    },
    {
      ...
      caption: "Holi sweets & colorful smiles 🌸",
      date: "Festival of Joy",
      alt: "Meghna celebrating with colors and sweets",
      category: "smiles",
      rotation: 3,
    },
    {
      ...
      caption: "Sunlit afternoons & effortless cool 😎",
      date: "Summer Days",
      alt: "Meghna in sunglasses under golden sunlight",
      category: "moments",
      rotation: -2,
    },
    {
      ...
      caption: "Lavender dreams & quiet poise 💜",
      date: "Soft Moments",
      alt: "Meghna in elegant lavender dress",
      category: "favorites",
      rotation: 3,
    },
    {
      id: "mem-7",
      src: "/images/meghna/Image-724.jpg",
      caption: "An effortless smile that brightens any room ☀️",
      date: "Sunshine Smile",
      alt: "Meghna portrait in yellow saree",
      category: "smiles",
      rotation: -1,
    },
    {
      id: "mem-8",
      src: "/images/meghna/Image-88907.jpg",
      caption: "Midnight elegance in classic black 🖤",
      date: "Evening Magic",
      alt: "Meghna in gorgeous black drape",
      category: "favorites",
      rotation: 2,
    },
  ] as MemoryItem[],
